...
airbnb_price = pd.read_csv('C:/JPEM_Git_Main/JPEM/JPEM_Datacamp/data/airbnb_price.csv')

# Import Excel file for room types
airbnb_room_type = pd.read_excel('C:/JPEM_Git_Main/JPEM/JPEM_Datacamp/data/airbnb_room_type.xlsx')

# Import TSV for review dates
airbnb_last_review = pd.read_csv('C:/JPEM_Git_Main/JPEM/JPEM_Datacamp/data/airbnb_last_review.tsv', sep='\t')
