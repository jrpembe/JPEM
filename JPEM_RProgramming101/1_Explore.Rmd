...
dim(mpg) # how many rows and columns are in your dataframe
#head(starwars)

str(starwars) # returns all variables, data types and a snapshot of the data

glimpse(mpg) # cleaner than str
...
#unique(df$hair_color) # use attach(starwars) to avoid having to type the df name
