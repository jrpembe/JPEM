import random as rand # immports all
# from random import choice - imports just choice: coin = choice(["heads", "tails"])


coin = rand.choice(["heads", "tails"]) # takes a sequence or list (square brackets)
